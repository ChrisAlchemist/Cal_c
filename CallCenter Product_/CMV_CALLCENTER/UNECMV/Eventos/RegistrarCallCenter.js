                                            ...
                                            if (socio[1].banca_activa == true && socio[1].id_motivo_bloqueo != 10) {
                                                ...
                                                if (socio[1].id_motivo_bloqueo != 1) {
                                                    ...
                                                    if ($("#idMotivoBloqueo").val() != 13) {
                                                        if ($("#idMotivoBloqueo").val() == 14) {
                                                            $("#myModalCuentaBloqueada-h4").text("Socio atendido anteriormente por el modulo de 'Alertas'.");
                                                        }
                                                        else {
                                                        ...
                                                        $('#myModalCuentaBloqueada').modal({ fadeDuration: 100, backdrop: 'static' });
